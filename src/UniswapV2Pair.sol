...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    uint256 public price0CumulativeLast; // 累积的 token1/token0 价格 × 时间
    uint256 public price1CumulativeLast; // 累积的 token0/token1 价格 × 时间
    uint256 public kLast; // 上次流动性变化时的 reserve0 × reserve1，用于手续费计算
